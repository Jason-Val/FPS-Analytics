  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-surface-container p-8 rounded-xl shadow-2xl relative overflow-hidden">
        ...
        <h1 className="text-3xl mb-2 text-primary font-display font-medium">FPS Analyst</h1>
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          ...
          <div>
            <div className="flex justify-between items-center mb-2">
              <label className="block text-sm font-medium text-on-surface-variant">Secure Password</label>
              <Link
